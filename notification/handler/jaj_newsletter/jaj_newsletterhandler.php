...
class jaj_NewsletterHandler extends eZNotificationEventHandler
{
    const NOTIFICATION_HANDLER_ID = 'jaj_newsletter';
    const TRANSPORT = 'ezmail';

    /*!
     Constructor
    */
    function jaj_NewsletterHandler()
    {
    ...
    function attributes()
    {
    	return eZNotificationEventHandler::attributes();
    	/*
